# Generated by Django 6.0.1 on 2026-01-24 04:05

import django.contrib.auth.validators
import django.db.models.deletion
import django.utils.timezone
import relationship_app.managers
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            managers=[
                ('objects', relationship_app.managers.CustomUserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Book',
            fields=[
                ...
                ('publication_year', models.PositiveIntegerField(blank=True, default=2026, null=True)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='books', to='relationship_app.author', verbose_name='author')),
            ],
            options={
